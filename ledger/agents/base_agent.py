...
class BaseApexAgent(ABC):
    ...
    """
    def __init__(self, agent_id: str, agent_type: str, store, registry, llm: LLMClient | None = None, model=os.getenv("OPENROUTER_MODEL", os.getenv("OLLAMA_MODEL", "google/gemini-2.5-flash")), client=None):
